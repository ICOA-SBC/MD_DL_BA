...
class Densecnn(nn.Module):
    ...
    def __init__(self, in_frames, features: nn.Module, regressor: nn.Module,
...
def create_densenucy(in_frames,
                     growth_rate: int = 96,
    ...
    model = Densecnn(in_frames=in_frames, features=features, regressor=regressor)
    return model
